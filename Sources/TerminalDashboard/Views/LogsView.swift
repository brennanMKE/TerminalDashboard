...
/// Renders the live log stream dashboard with color-coded severity levels,
/// a ring-buffer display, and pause/resume support.
///
...
private struct LogsContentView: View {
    ...
    private var commandInputRow: some View {
        HStack(spacing: 1) {
            Text(">").foregroundColor(.gray)
            TextField(placeholder: "p pause  c clear") { cmd in
